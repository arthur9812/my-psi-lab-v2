...
if __name__ == "__main__":
    ...
    for h5_file_name in h5_file_names:
        ...
        # episode['arm2_eef_quat'] = h5_file["robot"]["arm2_eef_state"][:,3:] # type: ignore
        # episode['arm2_vel'] = h5_file["robot"]["arm2_vel"] # type: ignore
        # episode['hand1_pos'] = h5_file["robot"]["hand1_pos"] # type: ignore
        # episode['hand1_vel'] = h5_file["robot"]["hand1_vel"] # type: ignore
        # episode['hand2_vel'] = h5_file["robot"]["hand2_vel"] # type: ignore
        # episode['arm1_camera_rgb'] = h5_file["sensor"]["arm1_camera_rgb.rgb"] # type: ignore
