...
VUER_PSI_DC_01_CFG = VuerTpCfg(
    ...
    left_hand_retarget_cfg = RetargetingConfig(
            type="vector",
            urdf_path=PSILAB_URDF_ASSET_DIR + "/inspired_hand/OY/Version_2.0/InspireHand_OY_Left/InspireHand_OY_Left.urdf",    #urdf相对路径
    ...
    right_hand_retarget_cfg = RetargetingConfig(
            type="vector",
            urdf_path=PSILAB_URDF_ASSET_DIR + "/inspired_hand/OY/Version_2.0/InspireHand_OY_Right/InspireHand_OY_Right.urdf",  #urdf相对路径
