...
parser.add_argument("--scene_from_json", action="store_true", default=False, help="Update Data to Wandb.")
parser.add_argument("--enable_store", action="store_true", default=False, help="Update Data to Wandb.")
...
# change scene from json while "scene_from_json" is True
if args_cli.scene_from_json:
